    ...
    <InformationStyles>
      ...
      >
        ...
        <div className="flex items-center justify-between step">
          ...
          <button
            className={`w-[200px] p-4 bg-blue-400 text-white rounded-lg mt-5 font-semibold ${
              isSubmitting ? "opacity-50" : ""
            }`}
            disabled={isSubmitting}
          >
            {!isSubmitting ? (
              <div className="w-8 h-8 mx-auto border-4 border-t-4 border-white rounded-full border-t-transparent border-b-transparent animate-spin"></div>
            ) : (
              "Tiếp tục thanh toán"
            )}
          </button>
