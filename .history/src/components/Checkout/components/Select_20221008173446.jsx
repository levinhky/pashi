...
const Select = ({ control, setValue, name, data, selectLabel, ...props }) => {
  ...
  return (
    <div
      className="relative focus:shadow-[0_0_0_10px_#338dbc] focus:outline-none focus:ring-sky-500 delay-200 shadow-md transition-all focus:ring-2 focus:border-transparent"
      ref={nodeRef}
    >
