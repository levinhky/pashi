  ...
  return (
    ...
    >
      <input
        ...
        // className="hidden"
        className={`mr-2 pr-2 border-none rounded-full w-[18px] h-[18px] transition-all relative cursor-pointer outline-0 ${className} transition-all hidden`}
      />
      <div className="w-full h-full transition-all bg-white rounded-full"></div>
      <img
        src={props.img}
        alt={props.imgAlt}
