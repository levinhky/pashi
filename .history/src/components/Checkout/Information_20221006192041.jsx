        ...
        <div className="pb-16 content">
          <div className="relative z-10">
            ...
            <div className="enter">
              ...
              />
              <div className="grid grid-cols-[300px_minmax(100px,_1fr)_auto] my-2">
                <input
                  type="text"
                  className="w-full border shadow-md focus:ring-2 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all delay-300 bg-white text-[#333] rounded-md p-[10px_40px_10px_12px] mr-4"
                  placeholder="Email"
                />
                <input
                  type="text"
