        ...
        <div className="pb-16 content">
          <div className="relative z-10">
            ...
            <div className="enter">
              <input
                type="text"
                className="w-full border shadow-md focus:ring-1 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all bg-white text-[#333] rounded-md p-[12px_40px_12px_12px]"
