            ...
            <div className="enter">
              ...
              <div className="grid grid-cols-3 select">
                <div className="relative field-select">
                  <label
                    htmlFor=""
                    className="absolute top-0 w-full px-3 my-3 text-lg font-normal truncate transition-all pointer-events-none z-1 text-[#999] block"
                  >
                    Tỉnh / thành
                  </label>
                ...
                <div className="relative field-select">
                  <label
                    htmlFor=""
                    className="absolute top-0 w-full px-3 my-[1_3] text-lg font-normal truncate transition-all pointer-events-none z-1 text-[#999] block"
                  >
                    Tỉnh / thành
                  </label>
                  <span className="absolute top-0 bottom-0 right-0 w-[50px] place-content-center bg-center icon">
