    ...
    <div className="flex flex-row-reverse">
      ...
      >
        ...
        <div className="checkout-info shadow-[0_0_0_1px_#d9d9d9] rounded-lg bg-white text-[#737373] p-4">
          <h2 className="mb-3 text-3xl font-medium">Thông tin đơn hàng</h2>
          <div className="nfo-delivery">
            <h3 className="font-medium i">Thông tin giao hàng</h3>
          ...
          <div className="payment">
            <h3 className="text-3xl font-medium">Phương thức thanh toán</h3>
            <p>Thanh toán online qua ví Momo</p>
          </div>
        </div>
