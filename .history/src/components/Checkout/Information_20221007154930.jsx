              ...
              <div className="grid grid-cols-3 gap-x-2 select">
                <div className="relative field-select">
                  ...
                  <select
                    name=""
                    id=""
                    className="text-2xl shadow-md block transition-all text-[#333] w-full break-normal p-[17px_40px_5px_11px] rounded-lg focus:box-border focus:outline-none focus:ring-sky-500 delay-300"
                  >
