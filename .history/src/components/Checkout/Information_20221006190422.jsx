        ...
        <div className="pb-16 content">
          <div className="relative z-10">
            ...
            <div className="enter">
              <input
                type="text"
                className="w-full p-2 border shadow-md focus:ring-1 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all bg-white text-[#333] rounded-md"
