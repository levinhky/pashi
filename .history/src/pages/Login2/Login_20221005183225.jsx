        ...
        <form action="" className="login-form col-sm-6 col-xs-12">
          ...
          <div className="w-[410px] mx-auto my-0">
            <div className="relative flex items-center ">
              ...
              <input
                type="text"
                className="w-full pl-11 h-[40px] mb-[15px] border-none bg-[#f2f2f2] text-[#777] outline-none "
            ...
            <div className="relative flex items-center ">
              ...
              <input
                type="password"
                className="w-full pl-11 h-[40px] mb-[15px] border-none bg-[#f2f2f2] text-[#777] outline-none pl-"
