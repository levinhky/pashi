    ...
    <div className={styles["wrapper"]}>
      <div className="my-20 login-top">
        ...
        <div className="flex flex-row items-center justify-center gap-x-4">
          <button
            className="w-[110px] h-full rounded-3xl py-2 px-3 bg-[#546ea6] text-white flex items-center hover:bg-[#b2c9fb] transition-all"
          ...
          <button
            className="w-[110px] h-full rounded-3xl py-2 px-3 bg-[#df5656] text-white flex items-center hover:bg-[#ffb5b5] transition-all"
