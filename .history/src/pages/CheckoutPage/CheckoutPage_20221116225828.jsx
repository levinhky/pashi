  ...
  return (
    <CheckoutPageStyles>
      ...
      <div className="hidden toggle-summary">
        <div className="wrap">
          <div className="flex items-center justify-around order-summary">
            {onClick && (<div className="order-summary-toggle-text">
              <div className="icon">
                <svg
                  width="20"
                  height="19"
            ...
            </div> ) : (<div className="order-summary-toggle-text">
              <div className="icon">
                <svg
                  width="20"
                  height="19"
