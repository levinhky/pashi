      ...
      <div className="hidden border-gray-300 py-7 bg-[#fafafa] toggle-summary border-y-[1px]">
        <div className="wrap">
          ...
          >
            ...
            <div className="text-4xl font-medium price">304,000đ</div>
          </div>
        </div>
      </div>
      ...
      <div className="content">
        <div className="flex flex-row-reverse h-full max-w-screen-xl py-0 mx-auto wrap">
          <div className="sidebar w-[44%] relative bg-[#fafafa] ">
            <div
              className={`sidebar-content pl-[8%] pt-20 ${
                !show ? "" : "opacity-0 h-0"
              }`}
            >
              {cartItems.length > 0 &&
              ...
              <div className="flex mb-4 py-4 h-[70px] items-center border-gray-300 border-b-[1px] code-sidebar">
              ...
              <div className="bill mb-4 border-gray-300 border-b-[1px]">
