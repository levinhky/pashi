  ...
  return (
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="flex h-[47px] code">
          ...
          <div className="relative w-full h-full p-2 code-input grow group">
            <input
              ...
              id="discount-code"
              required
              className="absolute w-full h-full px-4 border shadow-md focus:ring-2 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all delay-300 text-[#333] rounded-md p-[10px_40px_10px_12px] mb-4 bg-gray-100 outline-none peer text-2xl"
            />
            <label
              for="discount-code"
