...
const CheckoutPage = ({ children }) => {
  ...
  return (
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      ...
      <div className="block w-[300%] top-0 absolute bottom-0 -z-1 bg-[#fafafa] shadow-[1px_0_0_#e1e1e1_inset] left-0"></div>
      <div className="content bg-[#f5f5f5] w-[38%] pl-[4%] relative shadow-inner pt-20"></div>
    </div>
