    ...
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="sidebar-content pl-[4%] pt-20">
          <div className="content-item relative w-auto h-[65px] grid grid-cols-3">
            <div className="product-img absolute bg-[#d8d8d8] w-[65px] h-full rounded-lg">
              <img
            ...
            <div className="absolute flex flex-col px-4 description ">
              <span className="text-2xl font-bold">Purple Jayden Dress</span>
              <span>S</span>
            </div>
            <div className="absolute right-0 inline-block price">
              <span>590.000đ</span>
            </div>
          </div>
        </div>
