...
const CheckoutPage = ({ children }) => {
  ...
  return (
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      <div className="flex flex-column w-[60%] pr-[6%] pt-20">{children}</div>

      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        <div className="bg-left-top block w-[300%] top-0 absolute bottom-0 -z-10 shadow-[1px_0_0_#e1e1e1_inset]"></div>
        <div className="sidebar-content pl-[8%] pt-20">
          <div className="content-item w-auto h-[65px] grid grid-cols-[65px_minmax(260px,_1fr)_auto] ">
