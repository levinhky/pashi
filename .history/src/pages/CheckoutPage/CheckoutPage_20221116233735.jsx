      ...
      <div className="hidden content-second bg-[#fafafa] py-7 border-gray-300 border-b-[1px]">
        <div className="wrap">
          <div className="flex items-center h-[47px] code">
            ...
            />
            <button className="inline-block h-full w-auto px-7 py-0 ml-8 text-center rounded-lg whitespace-nowrap bg-[#338dbc] hover:brightness-125 text-white relative transition-all cursor-pointer font-medium">
              Sử dụng
            </button>
          </div>
        </div>
