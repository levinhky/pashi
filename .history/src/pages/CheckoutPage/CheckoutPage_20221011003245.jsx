          ...
          <div className="sidebar-content pl-[8%] pt-20">
            ...
            <div className="flex h-[47px] items-center code">
              <div className="relative w-full h-full p-2 code-input grow group">
                ...
                <label
                  for="discount-code"
                  className="absolute top-0 flex items-center pl-0 my-auto text-2xl transition-all transform left-8 group-focus-within:text-base peer-valid:text-base group-focus-within:h-1.5 peer-valid:h-1.5 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0 cursor-text"
                >
                  Mã giảm giá
                </label>
              </div>
