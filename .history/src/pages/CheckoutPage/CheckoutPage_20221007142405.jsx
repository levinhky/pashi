        ...
        <div className="flex code">
          <div className="relative grow code-input group">
            <label
              ...
              className="absolute top-0 left-0 z-30 flex items-center w-full h-full px-4 pl-2 mt-2 mb-3 text-sm transition-all ease-out delay-200 transform translate-y-2 pointer-events-none whitespace-nowrap text-ellipsis group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0"
            >
              Mã giảm giá
            </label>
            <input
