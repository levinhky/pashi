      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="flex code">
          ...
          <div className="relative code-input grow group">
            ...
            <label
              for="discount-code"
              className="absolute flex items-center pl-2 my-2 ml-4 text-2xl transition-all transform top-4 left-2 group-focus-within:text-base peer-valid:text-base group-focus-within:h-1/3 peer-valid:h-1/3 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0"
            >
              Username
            </label>
          </div>
