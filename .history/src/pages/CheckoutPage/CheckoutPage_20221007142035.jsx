    ...
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="flex code">
          <div className="relative grow code-input">
            <label
              htmlFor="discount-code"
              className="absolute top-0 z-30 block w-full px-4 mt-2 mb-3 transition-all ease-out delay-200 translate-y-2 pointer-events-none whitespace-nowrap text-ellipsis"
            >
              Mã giảm giá
            </label>
            <input
