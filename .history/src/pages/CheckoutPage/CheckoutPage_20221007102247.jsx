      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="sidebar-content pl-[4%] pt-20">
          <div className="content-item w-auto h-[65px] grid grid-cols-[65px_minmax(270px,_1fr)_100px]">
            <div className="product-img w-[65px] h-[65px] ">
              <div className="bg-[#d8d8d8] rounded-lg relative overflow-hidden">
                <img
              ...
              <span className="absolute bg-[rgba(153,153,153,0.9)] z-50 px-4 py-2 text-2xl font-medium quantity rounded-3xl -top-5 -right-5">
                1
              </span>
            </div>
