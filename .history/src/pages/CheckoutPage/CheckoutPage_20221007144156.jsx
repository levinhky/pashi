        ...
        <div className="flex code">
          ...
          <div className="relative code-input grow group">
            <input
              ...
              id="discount-code"
              required
              className="absolute w-full px-4 border shadow-md focus:ring-2 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all delay-300 text-[#333] rounded-md p-[10px_40px_10px_12px] mb-4 bg-gray-100 outline-none peer"
            />
            <label
              for="discount-code"
