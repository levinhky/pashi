      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="flex h-[56px] code">
          ...
          <div className="relative p-2 code-input grow group">
            ...
            <label
              for="discount-code"
              className="absolute top-0 flex items-center pl-2 my-4 ml-4 text-2xl transition-all transform left-2 group-focus-within:text-base peer-valid:text-base group-focus-within:h-0.5 peer-valid:h-0.5 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0"
            >
              Mã giảm giá
            </label>
          </div>
