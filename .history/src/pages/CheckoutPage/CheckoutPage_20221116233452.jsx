        ...
        <div className="wrap">
          <div className="flex h-[47px] items-center code">
            <input
              type="text"
              id="discount-code"
              className="absolute px-4 my-auto  border shadow-md focus:ring-2 focus:outline-none focus:border-sky-500 focus:ring-sky-500 transition-all delay-300 text-[#333] rounded-md p-[10px_40px_10px_12px] mb-4 bg-gray-100 outline-none peer text-2xl"
