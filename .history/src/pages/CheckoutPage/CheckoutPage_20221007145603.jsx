    ...
    <div className="flex flex-row flex-[1_0_auto] py-0 px-[5%] mx-auto w-[90%] max-w-screen-xl">
      ...
      <div className="sidebar w-[38%] relative bg-[#fafafa]">
        ...
        <div className="flex code">
          ...
          <button className="inline-block w-auto px-6 py-0 ml-2 text-center rounded-lg whitespace-nowrap bg-[#338dbc] text-white relative transition-all cursor-pointer font-medium">
            Sử dụng
          </button>
        </div>
      </div>
