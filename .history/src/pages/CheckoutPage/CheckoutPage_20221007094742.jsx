        ...
        <div className="sidebar-content pl-[4%] pt-20">
          <div className="content-item">
            <table className="relative table-auto">
              <tbody className="absolute table-row-group align-middle border-inherit">
                <tr className="table-row align-middle border-inherit w-[65px] h-[65px]">
                  <td className="w-full h-full p-0">
                    <img
